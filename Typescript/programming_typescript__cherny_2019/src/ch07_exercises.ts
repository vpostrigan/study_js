...
// In this API, every operation might fail
// — feel free to update the API’s method signatures to allow for Errs (or don’t, if you prefer).
// Think about how you might perform a sequence of actions while handling errors that come up
// (eg. getting the logged in user’s ID, then getting their list of friends).

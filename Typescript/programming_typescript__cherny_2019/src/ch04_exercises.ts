...
/* TypeScript always infers a function's return type.
   TypeScript sometimes infers a function's parameter types, if it can infer them from context
(for example, if the function is a callback). */
...
// 3. I want the ability to book a vacation that starts immediately.
// Update the overloaded reserve function from earlier in this chapter (Overloaded Function Types)
...
// 4. [Hard] Update our call implementation from earlier in the chapter
// (Using Bounded Polymorphism to Model Arity) to only work for functions whose second argument is a string.
// For all other functions, your implementation should fail at compile time.
